...
const EditUser = () =>{
    ...
    return(
        <Container>
            <Typography variant="h4" sx={{fontFamily: 'Pacifico', color: '#ffffff'}}>Edit User</Typography>
            <FormControl>
                <InputLabel sx={{fontFamily: 'Pacifico', color: '#ffffff'}}>Name</InputLabel>
                <Input sx={{color: '#ffffff'}} onChange={(e)=>onValueChange(e)} name="name" value={user.name}/>
            </FormControl>
            <FormControl>
                <InputLabel sx={{fontFamily: 'Pacifico', color: '#ffffff'}}>Username</InputLabel>
                <Input sx={{color: '#ffffff'}} onChange={(e)=>onValueChange(e)} name="username" value={user.username}/>
            </FormControl>
            <FormControl>
                <InputLabel sx={{fontFamily: 'Pacifico', color: '#ffffff'}}>Email</InputLabel>
                <Input sx={{color: '#ffffff'}} onChange={(e)=>onValueChange(e)} name="email" value={user.email}/>
            </FormControl>
            <FormControl>
                <InputLabel sx={{fontFamily: 'Pacifico', color: '#ffffff'}}>Phone</InputLabel>
                <Input sx={{color: '#ffffff'}} onChange={(e)=>onValueChange(e)} name="phone" value={user.phone}/>
            </FormControl>
            <FormControl>
